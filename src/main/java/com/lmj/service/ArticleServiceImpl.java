...
import com.lmj.mapper.ArticleMapper;
...
public class ArticleServiceImpl implements ArticleService{
    ...
    // TODO: 2024/3/13
    @Override
    public List<Article> querySelfAllArticle(int id) {
        return articleMapper.querySelfAllArticle(id);
    }
    ...
    @Override
    public List<Article> commonQueryArticleByLimit(int start, int pageSize,int id) {
        return articleMapper.commonQueryArticleByLimit(start,pageSize,id);
    }
    ...
    //文章检索并分页limit
    @Override
    public List<Article> commonQueryArticleByTitleLimit(String title, int start, int pageSize,int id) {
        return articleMapper.commonQueryArticleByTitleLimit(title,start,pageSize,id);
    }
    ...
    @Override
    public List<Article> queryArticleByTitle(String keyword) {
        return articleMapper.queryArticleByTitle(keyword);
    }
}
