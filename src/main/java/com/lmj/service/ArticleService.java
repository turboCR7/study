...
public interface ArticleService {
    ...
    //查询个人所有文章
    List<Article> querySelfAllArticle(int id);

    //分页查询limit
    List<Article> queryArticleByLimit(int start,int pageSize);

    List<Article> commonQueryArticleByLimit(  int start,  int pageSize ,int id);
    ...
    List<Article> commonQueryArticleByTitleLimit( String title,int start,int pageSize,int id);
    ...
    //文章搜索
    List<Article> queryArticleByTitle(String keyword);
}
