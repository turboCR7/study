...
public interface ArticleMapper {
    ...
    //查询个人所有文章
    List<Article> querySelfAllArticle(@Param("id")int id);

    //分页查询limit
    List<Article> queryArticleByLimit(@Param("start") int start,@Param("pageSize") int pageSize);

    //分页查询个人limit
    List<Article> commonQueryArticleByLimit(@Param("start") int start,@Param("pageSize") int pageSize ,int id);
    ...
    //查询个人文章
    List<Article> commonQueryArticleByTitleLimit(@Param("title") String title,@Param("start") int start,@Param("pageSize") int pageSize,@Param("id") int id);
}
